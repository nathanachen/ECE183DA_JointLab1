#---------------------
# 2/4 6:30PM (Phillip Segway)

import math

# GLOBALS
# if we want to stop a little before the wall, then adjust the x_max and y_max
x_max = 10000  # bounds of map
y_max = 10000
theta_max = 2*math.pi
d = 502 	# diameter of wheels in millimeters
w = 530   # distance between wheels in millimeters
